...
public class AgentPtyInitListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            LocalAgentPtyRunner runner = new LocalAgentPtyRunner(registry, List.of(AidaContext.home().toPath()));
            ...
            if (sc != null) {
                ...
                System.out.println("[AIDA] agent-pty WebSocket endpoint registered");
            } else {
                System.err.println("[AIDA] ServerContainer 없음 — WebSocket 미등록(websocket 의존성 확인)");
            }
        } catch (Exception e) {
            System.err.println("[AIDA] agent-pty 초기화 실패: " + e.getMessage());
            e.printStackTrace();
        }
    }
